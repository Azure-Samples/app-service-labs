...
description: "Build a secure, production-ready enterprise web app on Azure App Service across 11 connected steps."
sidebar_position: 1
slug: /learning-paths/enterprise-web-app
---
...
The app is **Zava Widgets**, a small product catalog. It starts by serving an
...
- [Node.js 22 or later](https://nodejs.org/) and [Git](https://git-scm.com/downloads).

The app for this path lives in the repository under
[`samples/zava-widgets`](https://github.com/Azure-Samples/app-service-labs/tree/main/samples/zava-widgets).
